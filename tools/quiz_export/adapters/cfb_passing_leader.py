"""CFB game passing leader -- objective "top offensive performer" (passing
...
OUT_PATH = None
CATEGORY = "CFB Game Passing Leader"
TRACK_ENTITY = True
...
def evaluate(c, row, rng, guard):
    return common.evaluate(
        ...
        entity_prefix="cfb_pass_ldr", min_season=MIN_SEASON, max_season=MAX_SEASON,
    )
...
def header_lines(seed: str) -> list[str]:
    return ["// Director-pipeline-only domain.", "// tools/quiz_export/adapters/cfb_passing_leader.py.", f"// Deterministic seed: \"{seed}\"."]
