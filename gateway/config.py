...
# "every registered Director capability is now public" -- adding a mode
# here is a deliberate certification decision made in
# gateway/services/public_game.py, not an automatic consequence of the
