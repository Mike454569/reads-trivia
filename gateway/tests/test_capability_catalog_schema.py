...
def test_mechanic_taxonomy_seeded_with_nine_templates_honest_pipeline_support_flags():
    ...
    the 8th (WEEKLY_PICKEM) and Phase 7B the 9th (LIVE_WEEKLY_FANTASY_DRAFT,
    tools/director_v04/live_weekly_fantasy_draft.py) -- all 9 are now
    honestly creator_pipeline_supported AND template_status=
    PRODUCTION_READY."""
    c = engine_bootstrap.connect()
    try:
