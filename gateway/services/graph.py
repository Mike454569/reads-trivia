...
# already gets this right; this module (and public_six_degrees.py/
# grid.py, same bug) did not, so every graph_explorer-backed route
# silently 503'd in production while working fine locally.
