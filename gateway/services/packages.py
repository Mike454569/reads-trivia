...
`GGP34:` (THREE_STRIKES), `GGP35:` (MYSTERY_ROSTER), `GGP36:` (DRAFT_PICK_LADDER), `GGP37:` (CATEGORY_ROULETTE), and `GGP38:`
(COMMON_LINK). MAP_THE_CAREER reuses
...
def _safe_filename_for_id(package_id: str) -> Path:
    ...
    character outside PACKAGE_ID_RE's fixed GGP(4-9|10-38)?:[0-9a-f]{24}
