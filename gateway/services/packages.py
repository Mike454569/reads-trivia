...
75-Format Expansion pass (Wave 1) added `GGP28:` (DOUBLE_OR_NOTHING) and
`GGP29:` (KING_OF_THE_HILL). MAP_THE_CAREER reuses `GGP6:` (SORTING_TIMELINE)
...
PACKAGE_ID_RE = re.compile(r"^GGP([4-9]|1[0-9]|2[0-9])?:[0-9a-f]{24}$")
...
def _safe_filename_for_id(package_id: str) -> Path:
    ...
    character outside PACKAGE_ID_RE's fixed GGP(4-9|10-29)?:[0-9a-f]{24}
