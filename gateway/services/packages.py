...
(PAIRWISE_COMPARE / HEAD_TO_HEAD_DUEL / BEST_OF_SEVEN_DUEL), `GGP19:`
...
`GGP29:` (KING_OF_THE_HILL), `GGP30:` (FACT_OR_FAKE), `GGP31:`
(GUESS_THE_RANKING), `GGP32:` (STAT_TARGET), `GGP33:` (REVERSE_TRIVIA),
`GGP34:` (THREE_STRIKES), `GGP35:` (MYSTERY_ROSTER), `GGP36:` (DRAFT_PICK_LADDER), and `GGP37:`
(CATEGORY_ROULETTE). MAP_THE_CAREER reuses
`GGP6:` (SORTING_TIMELINE)
...
PACKAGE_ID_RE = re.compile(r"^GGP([4-9]|1[0-9]|2[0-9]|3[0-7])?:[0-9a-f]{24}$")
...
def _safe_filename_for_id(package_id: str) -> Path:
    ...
    character outside PACKAGE_ID_RE's fixed GGP(4-9|10-37)?:[0-9a-f]{24}
