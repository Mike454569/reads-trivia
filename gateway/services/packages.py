...
`GGP34:` (THREE_STRIKES), and `GGP35:` (MYSTERY_ROSTER). MAP_THE_CAREER
reuses
...
PACKAGE_ID_RE = re.compile(r"^GGP([4-9]|1[0-9]|2[0-9]|3[0-5])?:[0-9a-f]{24}$")
...
def _safe_filename_for_id(package_id: str) -> Path:
    ...
    character outside PACKAGE_ID_RE's fixed GGP(4-9|10-35)?:[0-9a-f]{24}
