...
(PICK_THE_IMPOSTOR / UNIQUE_ONE_OUT), and `GGP20:` (MISSING_PIECE).
...
PACKAGE_ID_RE = re.compile(r"^GGP([4-9]|1[0-9]|20)?:[0-9a-f]{24}$")
...
def _safe_filename_for_id(package_id: str) -> Path:
    ...
    character outside PACKAGE_ID_RE's fixed GGP(4-9|10-20)?:[0-9a-f]{24}
