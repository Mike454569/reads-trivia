// Scheduled function (see netlify.toml) -- triggers the CFB conference
// standings / season records refresh
// (tools/data_refresh/cfb_standings_refresh.py). Engine-gap-audit
...
exports.handler = async () => triggerRefresh('cfb_standings');
