// Scheduled function (see netlify.toml) -- triggers the CFB betting lines
// refresh (tools/data_refresh/cfb_betting_lines_refresh.py). Engine-gap-
// audit operation, continuation -- CFBD-key-dependent, defaults to a
...
exports.handler = async () => triggerRefresh('cfb_betting_lines');
